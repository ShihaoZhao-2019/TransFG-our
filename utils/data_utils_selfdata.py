...
from .dataset_selfdata import CUB, CarsDataset, NABirds, dogs, INat2017,SelfData,FGVC_aircraft
...
def get_loader(args):
    ...
    if args.dataset == 'CUB_200_2011':
        ...
        test_transform=transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                    ...
                                    transforms.ToTensor(),
                                    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        trainset = SelfData(root=args.data_root, is_train=True, transform=train_transform)
        testset = SelfData(root=args.data_root, is_train=False, transform = test_transform)
...
# =============================================================================
        ...
        trainset = FGVC_aircraft(448,root=args.data_root, is_train=True )
        testset = FGVC_aircraft(448,root=args.data_root, is_train=False )
