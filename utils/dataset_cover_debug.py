...
class CUB():
    def __init__(self, root, is_train=True, data_len=None, transform=None):
        ...
        if self.is_train:
            ...
            '''
            num = 12
            self.train_img = self.train_img[0:num]
            self.train_label = self.train_label[0:num]
            self.train_imgname = self.train_imgname[0:num]
            self.train_bboxes = self.train_bboxes[0:num]
            '''
            num = 100
            self.train_img = [self.train_img[num]]
            self.train_label = [self.train_label[num]]
            self.train_imgname = [self.train_imgname[num]]
            self.train_bboxes = [self.train_bboxes[num]]
            
            print('\n')
            print('train-image',self.train_imgname)
            print('\n')
    ...
    def __getitem__(self, index):
        ...
        if self.is_train:
            ...
            '''
# =============================================================================
#             save_image = np.transpose(img,(1,2,0))
#             print('img_shape',save_image.shape)
#             print('img_type1',type(save_image))
#         
#             # save_image = save_image.numpy()
#         
#             print('img_type2',type(save_image))
#             cv2.imwrite('cover.jpg', save_image)
# =============================================================================
...
class dogs(Dataset):
    ...
    def __init__(self,
        ...
        num = 350
        self._flat_breed_images = [self._flat_breed_images[num]]
        self._breed_annotations = [self._breed_annotations[num]]
        
        print('\n')
        print('train-image',self._flat_breed_images)
        print('\n')
...
# =============================================================================
#         save_image = np.transpose(image,(1,2,0))
#         print('img_shape',save_image.shape)
#         print('img_type1',type(save_image))
#         
#         save_image = save_image.numpy()
#         
#         print('img_type2',type(save_image))
#         cv2.imwrite('cover.jpg', save_image*255)
# =============================================================================
...
# =============================================================================
        ...
        image_savepath = os.path.join('/data/kb/tanyuanyong/TransFG-master/debug/','cover.jpg')
