...
from models.modeling_ViTcover_fixFG_li import VisionTransformer, CONFIGS 
...
def main():
    ...
    parser.add_argument("--dataset", choices=["CUB_200_2011", "car", "dog", "nabirds", "INat2017","selfdata","FGVC_aircraft"], default="CUB_200_2011",
                        help="Which dataset.")
