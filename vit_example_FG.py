...
# =============================================================================
# from models.modeling_fixFG_CAM import VisionTransformer, CONFIGS
# =============================================================================
from models.modeling_selfdata_CAM_li import VisionTransformer, CONFIGS
...
# =============================================================================
#     if args.model == 0.5:
#         pretrained_model = '/data/kb/tanyuanyong/TransFG-master/output/FGcover_fixFG_e2_5_checkpoint.bin'
#     
#     elif args.model == 0.7:
#         pretrained_model = '/data/kb/tanyuanyong/TransFG-master/output/FGcover_fixFG_e2_7_checkpoint.bin'
#     else:
...
# =============================================================================
#     if args.model == 0.5:
#         pretrained_model = '/data/kb/tanyuanyong/TransFG-master/output/82.3FG_coverdog_1e2_checkpoint.bin'
#     else:
...
# =============================================================================
#     if args.model == 500:
#         pretrained_model = '/data/kb/tanyuanyong/TransFG-master/output/SEV_FG/SEV_FG_selfdataV1.9_3e2_500_checkpoint.bin'
#     elif args.model == 700:
#         pretrained_model = '/data/kb/tanyuanyong/TransFG-master/output/SEV_FG/SEV_FG_selfdataV1.9_3e2_700_checkpoint.bin'
#     elif args.model == 1000:
#         pretrained_model = '/data/kb/tanyuanyong/TransFG-master/output/SEV_FG/SEV_FG_selfdataV1.9_3e2_1000_checkpoint.bin'
#     else:
